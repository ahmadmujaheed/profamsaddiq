                ...
                <div className="relative z-10 px-8 text-center">
                    ...
                    >
                        ...
                        <p className="mx-auto mt-8 max-w-4xl text-lg leading-relaxed text-slate-300 md:text-xl">
                            Building collaborative agricultural solutions through
                            research, consultancy, field expertise, and sustainable
                            development initiatives focused on food security, soil
                            health, and agricultural transformation.
                        </p>
                    ...
                    <div className="flex flex-col gap-10 md:flex-row md:items-center md:justify-between">
                        <div className="max-w-4xl">
                            ...
                            <h2 className="mt-5 text-4xl font-light leading-tight md:text-6xl">
                                Advancing Sustainable Agricultural Systems Through
                                Strategic Collaboration
                            </h2>

                            <p className="mt-8 text-lg leading-relaxed text-slate-500">
                                Prof. A.M. Saddiq collaborates with government
                                institutions, development organizations, agricultural
                                agencies, research institutions, and sustainability
                                programs to support practical agricultural innovation,
                                soil management systems, climate resilience, and food
                                security initiatives across Africa.
                            </p>
                        </div>
            ...
            <section className="px-8 py-24 md:px-20">
                <div className="grid gap-6 md:grid-cols-4">
                    {[
                        ...
                        >
                            <h3 className="text-3xl font-bold text-[#C99B3B]">
                                {item.value}
                            </h3>
                ...
                <div className="grid gap-8 md:grid-cols-2">
                    {partnershipAreas.map((item, i) => (
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            transition={{ delay: i * 0.1 }}
                            className="rounded-[32px] border border-slate-100 bg-white p-10 shadow-sm transition-all hover:shadow-xl"
                        >
            ...
            <section className="px-8 py-32 md:px-20 bg-white">
                <div className="text-center mb-20">
                    ...
                    <p className="max-w-3xl mx-auto mt-8 text-lg text-slate-500 leading-relaxed">
                        ...
                        international development organizations, agricultural agencies,
                        and sustainability-focused programs supporting food security and
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                    {organizations.map((org, i) => (
                        <motion.div
                            ...
                            whileHover={{ y: -8 }}
                            className="group bg-[#f8f9fa] border border-slate-100 rounded-3xl p-10 flex flex-col items-center justify-center text-center hover:shadow-xl hover:border-[#C99B3B]/20 transition-all"
                        >
                    ...
                    <div className="grid gap-16 md:grid-cols-2">
                        ...
                        <div>
                            ...
                            <h2 className="text-4xl font-light leading-tight md:text-6xl">
                                “Partnerships become impactful when scientific
                                research creates sustainable agricultural solutions
                                that directly benefit communities and food systems.”
                            </h2>
                        </div>
                        ...
                        <div className="space-y-8 text-lg leading-relaxed text-slate-600">
                            <p>
                                ...
                                institutions, policymakers, development agencies,
                                agricultural industries, and farming communities.
                            </p>

                            <p>
                                His consultancy approach combines scientific
                                expertise, field experience, environmental
                                sustainability, and practical implementation
                                strategies to support long-term agricultural
            ...
            <section className="border-t border-slate-100 px-8 py-28 md:px-20">
                <div className="mx-auto max-w-5xl text-center">
                    ...
                    <p className="mx-auto mt-10 max-w-4xl text-lg leading-relaxed text-slate-500">
                        Available for collaborative agricultural projects,
                        sustainability initiatives, consultancy engagements,
                        institutional partnerships, and food security programs
                        focused on practical agricultural transformation.
                    </p>
