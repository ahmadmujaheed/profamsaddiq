...
const publications = [
  {
    ...
    authors:
      "Musa S. A., Ibrahim A. Saddiq, A. M. and Modibbo A. M.",
    journal:
...

  {
    ...
    authors: "Waizah Yakub, A. M. Saddiq and A. Salem",
    journal:
      "FUW Journal of Agriculture and Life Sciences 1:163-178",
    category: "Soil Science",
  },

  {
    ...
    journal:
      "Global Journal of Geography and Environmental Sciences",
    category: "Climate & Agriculture",
  },
...

  {
    ...
    journal:
      "FUW Trends in Science and Technology Journal",
    category: "Nutrient Management",
  },

  {
    ...
    authors:
      "A. M. Saddiq, A. Ibrahim, M. Y. Jada, A. M. Tahir and I. Umar",
...

  {
    ...
    authors:
      "Alhassan I., Saddiq A. M., Singh L. and Timon F.",
    journal:
      "Gashua Journal of Irrigation and Desertification",
    category: "Rice Production",
  },
];
...
const page = () => {
  ...
  return (
    <div className="min-h-screen bg-[#FCFCFC] pb-20 overflow-hidden">
      {/* ====================================================== */}
      {/* HERO SECTION */}
      {/* ====================================================== */}
        ...
        <div className="relative z-10 px-8 text-center">
          ...
          >
            ...
            <p className="mx-auto mt-8 max-w-3xl text-lg leading-relaxed text-slate-300 md:text-xl">
              A comprehensive body of research focused on soil
              fertility, sustainable agriculture, climate-smart
              farming, nutrient management, and agricultural
      ...
      <header className="relative z-20 -mt-12 mb-20 px-8 md:px-20">
        <div className="max-w-5xl rounded-[32px] border border-slate-100 bg-white p-8 shadow-xl md:p-14">
          <div className="flex flex-col gap-10 md:flex-row md:items-center md:justify-between">
            <div className="max-w-3xl">
              ...
              <p className="mt-6 text-lg leading-relaxed text-slate-500">
                Prof. A.M. Saddiq’s research contributions span soil
                chemistry, fertilizer management, crop productivity,
                climate-smart agriculture, irrigation systems,
                environmental sustainability, and food security
                initiatives with practical application for farmers and
      ...
      {/* MAIN CONTENT */}
      {/* ====================================================== */}
      <div className="flex flex-col gap-16 px-8 md:px-20 lg:flex-row">
        {/* ====================================================== */}
        {/* SIDEBAR */}
        {/* ====================================================== */}
        <aside className="space-y-8 lg:w-1/4 lg:sticky lg:top-12 h-fit">
          {/* SEARCH */}
          <div className="relative">
            <Search
            ...
            <input
              ...
              className="w-full rounded-2xl border border-slate-200 bg-white py-4 pl-12 pr-4 shadow-sm transition-colors focus:border-[#C99B3B] focus:outline-none"
            />
          </div>
          ...
          <div className="rounded-3xl border border-slate-100 bg-white p-8 shadow-sm">
            ...
            <p className="mt-4 text-sm leading-relaxed text-slate-500">
              Explore Prof. Saddiq’s scholarly contributions in soil
              science, climate-smart agriculture, nutrient management,
              irrigation systems, and environmental sustainability.
            </p>
          ...
          <div className="space-y-8">
            {filteredPublications.map((pub, i) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: i * 0.05 }}
                className="group relative cursor-default rounded-[32px] border border-slate-100 bg-white p-8 shadow-sm transition-all hover:border-[#C99B3B]/30 hover:shadow-xl"
              >
      ...
      <section className="px-8 pb-20 pt-32 md:px-20">
        <div className="rounded-[40px] bg-slate-950 p-14 text-white md:p-24">
          <div className="max-w-5xl">
            ...
            <h2 className="mt-6 text-4xl font-light leading-tight md:text-6xl">
              "Scientific research becomes truly meaningful when it
              creates practical solutions for sustainable agriculture,
            ...
            <p className="mt-10 max-w-3xl text-lg leading-relaxed text-slate-400">
              ...
              commitment to bridging scientific discovery with
              real-world agricultural application through soil
              fertility management, sustainable nutrient systems,
              climate-smart farming practices, and environmentally
